...
d.prev().attr({"aria-selected":"false","aria-expanded":"false"});b.length&&d.length?d.prev().attr({tabIndex:-1,"aria-expanded":"false"}):b.length&&this.headers.filter(function(){return 0===parseInt(c(this).attr("tabIndex"),10)}).attr("tabIndex",-1);b.attr("aria-hidden","false").prev().attr({"aria-selected":"true","aria-expanded":"true",tabIndex:0})},_animate:function(a,b,c){var f,e,g,k=this,l=0,p=a.css("box-sizing"),h=a.length&&(!b.length||a.index()<b.index()),m=this.options.animate||{},h=h&&m.down||
m,n=function(){k._toggleComplete(c)};"number"===typeof h&&(g=h);"string"===typeof h&&(e=h);e=e||h.easing||m.easing;g=g||h.duration||m.duration;if(!b.length)return a.animate(this.showProps,g,e,n);if(!a.length)return b.animate(this.hideProps,g,e,n);f=a.show().outerHeight();b.animate(this.hideProps,{duration:g,easing:e,step:function(a,b){b.now=Math.round(a)}});a.hide().animate(this.showProps,{duration:g,easing:e,complete:n,step:function(a,c){c.now=Math.round(a);"height"!==c.prop?"content-box"===p&&(l+=
c.now):"content"!==k.options.heightStyle&&(c.now=Math.round(f-b.outerHeight()-l),l=0)}})},_toggleComplete:function(a){var b=a.oldPanel,c=b.prev();this._removeClass(b,"ui-accordion-content-active");this._removeClass(c,"ui-accordion-header-active")._addClass(c,"ui-accordion-header-collapsed");b.length&&(b.parent()[0].className=b.parent()[0].className);this._trigger("activate",null,a)}})});