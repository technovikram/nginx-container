...
(function() {
	...
	tinymce.create('tinymce.plugins.SpellcheckerPlugin', {
		...
		init : function(ed, url) {
			...
			t.url = url;
			t.editor = ed;
			t.rpcUrl = ed.getParam("spellchecker_rpc_url", "../SpellChecker/jazzy-spellchecker");
			...
			//to fix- double time click on spellcheck button to off spellcheck - start
			...
			//to fix- double time click on spellcheck button to off spellcheck - end
		...
		_markWords : function(wl) {
			...
			//To fix- on cursor word ignored by spellchecker -start
			//var se = ed.selection, b = se.getBookmark();
			var se = ed.selection;
			//To fix- on cursor word ignored by spellchecker -end
		...
		_showMenu : function(ed, e) {
			...
			//To fix - space get removed while do on spellcheck
			var se = ed.selection, b;
